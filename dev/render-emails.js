...
const RENDERS = [
...

  {
    ...
    data: {
      ...
      stayPlan: [
        { date: '2026-09-26', visits: [{ slot: 'midday', extra: true }], overnight: true },
        { date: '2026-09-27', visits: [{ slot: 'midday', extra: false }], overnight: true },
        { date: '2026-09-28', visits: [{ slot: 'morning', extra: false }], overnight: false },
      ],
      isNewAccount: false,
      portalSetupLink: null,
    },
  ...
  {
    template: 'portal-reservation-confirmed',
    variant: 'overnight-no-extras',
    label: 'Overnight, no extra drop-ins',
    petCount: 1,
    data: {
      firstName: 'Sam',
      petNames: ['Bailey'],
      serviceLabel: 'Overnight Stay',
      startDateStr: '2026-10-02',
      endDateStr: '2026-10-04',
      totalDollars: 230,
      chargeDateStr: '2026-10-01',
      stayPlan: [
        { date: '2026-10-02', visits: [{ slot: 'midday', extra: false }], overnight: true },
        { date: '2026-10-03', visits: [{ slot: 'midday', extra: false }], overnight: true },
        { date: '2026-10-04', visits: [], overnight: false },
      ],
      needsCard: false,
    },
  },
