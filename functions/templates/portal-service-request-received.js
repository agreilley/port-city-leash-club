...
//                           // "feeding" (doesn't apply to a walk), and
//                           // "dog" rather than "pet"
// }
...
function text(data) {
  ...
  const lines = [
    ...
    '',
    data.isWalk ? `We'll confirm everything shortly. In the meantime, you can update your ${possessive(petCount, 'dog', 'dogs')} routine or any other details anytime in your ${possessive(petCount, 'dog', 'dogs')} profile in the portal.` : `We'll confirm everything shortly. In the meantime, you can update your ${possessive(petCount, 'pet', 'pets')} routine, feeding, or any other details anytime in your ${possessive(petCount, "pet", "pets")} profile in the portal.`,
    '',
